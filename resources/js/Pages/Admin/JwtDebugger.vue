        ...
        new Chart(trafficChartRef.value.getContext('2d'), {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    backgroundColor: 'rgba(245, 158, 11, 0.1)', // Amber-500 tint
...
<template>
    <AdminLayout title="JWT Debugger Analytics">
        <div class="space-y-8 animate-fade-in">
            <!-- Header -->
            <div>
                <h3 class="text-2xl font-bold text-white mb-1">JWT Debugger Traffic</h3>
                <p class="text-gray-400 text-sm font-medium">Monitoring client-side JWT processing visits and key metadata traffic logs.</p>
            </div>
                    ...
                    <table class="w-full text-left border-collapse">
                        ...
                        <tbody class="divide-y divide-gray-850/60 text-sm">
                            <tr v-for="log in recentVisits" :key="log.id" class="hover:bg-gray-800/20 transition-colors group">
                                <td class="py-4 font-mono text-xs font-bold text-amber-400">
                                    {{ log.ip_address }}
                                </td>
                                <td class="py-4">
                                    <div v-if="log.user">
