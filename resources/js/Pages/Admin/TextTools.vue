...
<template>
    <AdminLayout title="Text Tools Analytics">
        <div class="space-y-8 animate-fade-in">
            <!-- Header -->
            <div>
                <h3 class="text-2xl font-bold text-white mb-1">Text Tools Traffic</h3>
                <p class="text-gray-400 text-sm font-medium">Monitoring client-side text processing traffic and user activity logs.</p>
            </div>

            <!-- Stats -->
            <div class="grid grid-cols-2 lg:grid-cols-4 gap-4">
                <div v-for="s in [
                    { label: 'Total Page Hits', value: stats.totalHits, color: 'rose', icon: 'M15 12a3 3 0 11-6 0 3 3 0 016 0z M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z' },
                    { label: 'Active Edge IPs', value: stats.uniqueIPs, color: 'emerald', icon: 'M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z' },
                    { label: 'Today Hits', value: stats.todayHits, color: 'indigo', icon: 'M13 10V3L4 14h7v7l9-11h-7z' },
                    { label: 'Authenticated Hits', value: stats.authVisits, color: 'purple', icon: 'M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z' },
                    ...
                    <div class="flex items-center justify-between mb-3">
                        <div :class="['p-2 rounded-lg bg-opacity-10 text-opacity-100 group-hover:scale-110 transition-transform bg-rose-500/10 text-rose-400']">
                    ...
                    <table class="w-full text-left border-collapse">
                        ...
                        <tbody class="divide-y divide-gray-850/60 text-sm">
                            <tr v-for="log in recentVisits" :key="log.id" class="hover:bg-gray-800/20 transition-colors group">
                                <td class="py-4 font-mono text-xs font-bold text-rose-450">
                                    {{ log.ip_address }}
                                </td>
                                <td class="py-4">
                                    <div v-if="log.user">
