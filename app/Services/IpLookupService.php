...
{
    private static array $seedRates = [
        'EUR' => 0.92,
        'GBP' => 0.78,
        'INR' => 83.3,
        'CAD' => 1.36,
    ...
    public function getExchangeRates(): array
    {
        ...
        try {
            ...
            if ($response->successful()) {
                ...
                if (!empty($data)) {
                    ...
                    return array_merge(self::$seedRates, $data);
                }
            }
        } catch (\Exception $e) {
        ...
        if (!empty($fallback)) {
            ...
            return array_merge(self::$seedRates, $fallback);
        }
